...
export const WEEKS: WeekTemplate[] = [
  ...
  },
  {
    ...
    tasks: [
      { id: "w2_t1", label: "Hit protein target 5 of 7 days" },
      { id: "w2_t2", label: "Add one soluble fiber source to each meal" },
  ...
  },
  {
    ...
    tasks: [
      { id: "w4_t1", label: "Enforce caffeine cutoff at 12 PM all 7 days" },
  ...
  },
  {
    ...
    tasks: [
      { id: "w5_t1", label: "Hit 30g+ total fiber for 5 of 7 days" },
      { id: "w5_t2", label: "Protein target every meal, every day" },
  ...
  },
  {
    ...
    tasks: [
      { id: "w8_t1", label: "Daily off-ramp practice — 7 of 7 days" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "w11_t2", label: "Sleep ≥7 hours every night" },
